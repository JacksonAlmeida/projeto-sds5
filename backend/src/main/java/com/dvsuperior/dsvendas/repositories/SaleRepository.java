...
public interface SaleRepository extends JpaRepository<Sale, Long>  {
	...
	List<SaleSumDTO> amountGroupedBy();
	
	@Query("SELECT new com.dvsuperior.dsvendas.dto.SaleSucessDTO(obj.seller, SUM(obj.visited), SUM(obj.deals))"
			+ "FROM Sale AS obj GROUP BY obj.seller")
	List<SaleSucessDTO> sucessGroupedBy();
